         ...
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
               ...
               <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                     <li><a class="waves-effect waves-dark" href="{{ url('/scheme') }}"><i class="icon-arrow-right"></i> Scheme</a>

                     <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="{{ url('/scheme/electrician') }}"><i class="icon-arrow-right"></i>Electrician</a></li>
                        <li><a class="waves-effect waves-dark" href="{{ url('/scheme/dealer') }}"><i class="icon-arrow-right"></i>Dealer</a></li>
                        <li><a class="waves-effect waves-dark" href="{{ url('/scheme/partner') }}"><i class="icon-arrow-right"></i>Partner</a></li>
               ...
               <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                     ...
                     <li><a class="waves-effect waves-dark" href="{{ url('/failed-transaction') }}"><i class="icon-arrow-right"></i> Failed Transaction</a></li>
                      ...
                      <li><a class="waves-effect waves-dark" href="{{ url('/daily-limit') }}"><i class="icon-arrow-right"></i>Add Daily Limit</a></li>
               ...
               <li class="treeview">
                 ...
                 <i class="fa fa-file" aria-hidden="true"></i><span>Manage Page</span><i class="icon-arrow-down"></i></a>
                  <ul class="treeview-menu">
                    <li><a class="waves-effect waves-dark" href="{{ url('/about_us') }}"><i class="icon-arrow-right"></i>About us</a></li>
                    <li><a class="waves-effect waves-dark" href="{{ url('/banner') }}"><i class="icon-arrow-right"></i>Banner</a></li>

                    <li><a class="waves-effect waves-dark" href="{{ url('/social-media') }}"><i class="icon-arrow-right"></i>Social Media</a></li>
