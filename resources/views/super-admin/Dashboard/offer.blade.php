                        ...
                        <div class="container mt-2 p-5">
                           <div class="row justify-content-center">
                              <div class="col-12  " id="form" >
                                 <h3 class="mt-2 "> Add Offer</h3>
                                 <form action="{{url('/offer/add')}}" class="mt-3" method="post"  enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                       <input type="text" name="offer" class="form-control"  placeholder="Offer Name*" required>
                                    </div>
                                    <div class="form-group">
...
@endphp
                        ...
                        <tr>
                           ...
                           <td><b>{{$i}}</b></td>
                           <td class="col-2 ">
                           <img src="{{ asset('storage/images/'.$offer->image) }}" class="img-fluid" style="width:50px;" alt="">
                           </td>
                           <td class="col-3 ">
                             {{$offer->point}}
                           </td>
                                          ...
                                          <div class="container mt-2 p-5">
                                             <div class="row justify-content-center">
                                                <div class="col-12  " id="form">
                                                   ...
                                                   <form action="{{url('/offer/update')}}" class="mt-3" method="post"  enctype="multipart/form-data">
                                                    @csrf
