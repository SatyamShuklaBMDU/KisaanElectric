         ...
         <div class="container-fluid">
            ...
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <!-- Striped Row Table starts -->
                  <div class="card">
                     <div class="card-header">
                        <h5 class="card-header-text">Striped rows</h5>
                        <p>Add <code>.table-inverse</code> Class in table tag</p>
                     </div>
                     <div class="card-block">
                        <div class="row">
                           <div class="col-sm-12 table-responsive">
                  ...
                  <!-- Background Utilities table starts -->
                  <div class="card">
                     <div class="card-header">
                        <h5 class="card-header-text">Background Utilities</h5>
                        <p>Regular table background variants are not available with the inverse table, however, you may use <code>text or background utilities</code> to achieve similar styles.</p>
                     </div>
                     <div class="card-block">
                        <div class="row">
                           <div class="col-sm-12 table-responsive">
