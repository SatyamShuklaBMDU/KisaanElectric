...
@endphp
                        @foreach ( $history as $history )
                           ...
                           <td><b>{{$i}}</b></td>
                           <td class="col-2 ">
                              <img src="{{ asset('storage/images/'.$history->image) }}" class="img-fluid" style="width:50px;" alt="">
                           </td>
                           <td class="col-3 ">
                             {{$history->cin_no}}
                           </td>
                           ...
                           <td class="col">
                              <div class=" d-flex">
                                 ...
                                 <div class="delet">
                                   <a href="{{url('/scheme_history/delete/'.$history->id)}}"> <i class="fa-solid fa-trash"></i></a>
                                 </div>
                              </div>
                           </td>
                        </tr>
