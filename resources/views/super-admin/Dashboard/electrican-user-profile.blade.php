            ...
            <div class="col-sm-12 p-0">
               <div class="main-header">
                  ...
                  <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                     ...
                     <li class="breadcrumb-item"><a href="approved-user-status.html" style="color: rgb(2, 2, 78);">Electrican</a>
                     </li>
                  </ol>
               </div>
            </div>
                 ...
                 <div class="col-md-12 boder-danger me-5 pe-5">
                    <div class="row mb" style="margin-bottom: 30px; width:175%;">
                        ...
                        <div class="col-sm-3 end-date">
                            ...
                            <form action="{{url('/electrican-user-profile/filter')}}" method="post">
                                @csrf
