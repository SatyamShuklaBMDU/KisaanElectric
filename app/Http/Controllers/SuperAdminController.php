...
class SuperAdminController extends Controller
{
    ...
    public function pendingUser()
    {
        ...
        $user = User::where('status', '=', 'Pending')->orderBy('created_at', 'desc')->get();
    ...
    public function pendingUserFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;

        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('status', '=', 'Pending')
    ...
    public function approvedUserfilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('status', '=', 'Approved')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
    ...
    public function partnerProfileFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('profession','partner')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
    ...
    public function showCategoriesProductFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;

        // $user = auth()->user();
        $join = Product_category::whereDate('category.created_at', '>=', $startDate)
        ->whereDate('category.created_at', '<=', $endDate)
        ->orderBy('created_at', 'desc')
        ->join('series_product', 'series_product.id', '=', 'category.series_no')->get(['category.id','category.image','category.category','category.created_at','series_product.Series']);
...
$series=Series_product::all();
    ...
    public function dealerProfileFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('profession','dealer')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
    ...
    public function electricianProfileFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('profession','electrician')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
    ...
    public function blockUserFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('status', '=', 'Block')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
    ...
    public function suspendedUserFilter(Request $req)
    {
        $startDate = $req->start;
$endDate = $req->end;
        ...
        // $user = auth()->user();
        $user = User::whereDate('created_at', '>=', $startDate)
        ->whereDate('created_at', '<=', $endDate)->where('status', '=', 'Suspended')
        ->orderBy('created_at', 'desc')
        ->get();
        // $UserProfiles=compact('UserProfiles');
        // return redirect()->back()->with('UserProfiles');
...
$endDate = $req->end;
        ...
        return view('super-admin/Dashboard/suspended-user-status', compact('series'));
    ...
    public function approvedUser()
    {
        ...
        $user = User::where('status', '=', 'Approved')->orderBy('created_at', 'desc')->get();
        return view('super-admin/Dashboard/approved-user-status', compact('user'));
    ...
    public function suspendedUser()
    {
        ...
        $user = User::where('status', '=', 'Suspended')->orderBy('created_at', 'desc')->get();
        return view('super-admin/Dashboard/suspended-user-status', compact('user'));
...
// dd($term);
    ...
    public function usertransactionHistory($id)
    {


        $term=Transaction_history::where('user_id', $id)->get();
    //    $user=User::All();
    //    $term=compact('term');
    //    $user=compact('user');
// dd($term);
        ...
        return view('super-admin/Dashboard/user-transaction-history',compact('term'));
...
// ->join('series_product', 'product.series', '=', 'series_product.id')
// // ->join('_product_category', 'product.category', '=', '_product_category.id')
// ->select('product.*', 'series_product.Series' )
// ->get();
// $product=::all();
        // $series=Series_product::all();
        // return redirect()->back()->with('message', ' Delete Successfully');
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
        // $series=Series_product::all();
        return redirect()->back()->with('message', ' Delete Successfully');
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
    ...
    {   $image = $req->file('image');
        ...
        Offer::create(['for'=>$req->for,'title'=>$req->offer,'image'=>$imageName,'point'=>$req->points,'status'=>'Active','upto'=>$req->upto]);
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
        ...
        // return view('super-admin/Dashboard/offer');
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
        // $series=Series_product::all();
        // return redirect()->back()->with('message', ' Delete Successfully');
        return view('super-admin/Dashboard/offer',compact('offer'));
...
$category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no')->get(['category.id','category.image','category.category','category.created_at','series_product.Series']);
// dd($join);
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
        // $series=Series_product::all();
        // return redirect()->back()->with('message', ' Delete Successfully');
        return view('super-admin/Dashboard/add-new-product',compact('series','category'));
...
// $category=Product_category::join('series_product', 'series_product.id', '=', 'category.series_no');
        // $series=Series_product::all();
        // return redirect()->back()->with('message', ' Delete Successfully');
        return view('super-admin/Dashboard/edit-product');
...
// $series=Series_product::all();
    ...
    public function electricianProfile()
    {
        ...
        // $term=Point_history::orderBy('created_at', 'desc')->get();
       $user=User::where('profession','electrician')->orderBy('created_at', 'desc')->get();
    ...
    public function dealerProfile()
    {
        ...
        // $term=Point_history::orderBy('created_at', 'desc')->get();
       $user=User::where('profession','dealer')->orderBy('created_at', 'desc')->get();
    ...
    public function   partnerProfile()
    {
        ...
        // $term=Point_history::orderBy('created_at', 'desc')->get();
       $user=User::where('profession','partner')->orderBy('created_at', 'desc')->get();
    ...
    public function addOneProduct(Request $req)
    {
        // return $req->all();
...
$date=date('d-m-Y');
    ...
    public function showSchemeHistory()
    {


        $history=Scheme_history::where('status','Redeem')->orderBy('created_at', 'desc')->get();
        // $banner = Banner::all();

        // $user=User::where('status','=','Block')->get();
        return view('super-admin/Dashboard/scheme-history',compact('history'));
    }
    ...
    public function userPointHistorys($id)
    {
        ...
        // $user=User::where('status','=','Block')->get();
        return view('super-admin/Dashboard/user-point-history',compact('term'));
    }
    ...
    public function pendingschemedeliver()
    {


        $history=Scheme_history::where('status','pending')->orderBy('created_at', 'desc')->get();
        // $banner = Banner::all();

        // $user=User::where('status','=','Block')->get();
        return view('super-admin/Dashboard/pending-scheme-deliver',compact('history'));
    }
    ...
    public function deleteSchemeHistory($id)
    {

        $history=Scheme_history::where('id',$id)->delete();
        // $banner = Banner::all();
    ...
    public function showOrderHistory()
    {
        ...
        $history=Order::where('status','success')->orderBy('created_at', 'desc')->get();
        // $banner = Banner::all();

        // $user=User::where('status','=','Block')->get();
        return view('super-admin/Dashboard/order-history',compact('history'));
    }
    ...
    {    $history=Order::orderBy('created_at', 'desc')->get();
        // $banner = Banner::all();

        // $user=User::where('status','=','Block')->get();
        // return redirect()->back()->with('message', ' Delete Successfully');

        return view('super-admin/Dashboard/dealer-order',compact('history'));
    }
    ...
    public function dealerOrderStatus(Request $req)
    {

if($req->type=="success"){
    $history=Order::where('id', $req->id)->update(["status"=>"success"]);

}else if($req->type=="cancelled"){
    $history=Order::where('id', $req->id)->update(["status"=>"cancelled"]);
}
        // $history=Order::where('id', $req->id)->update(["status"=>$req->]);
        // $banner = Banner::all();
    ...
    public function invoice($id)
    {
        ...
        $history=Order::where('order.order_id',$id)->
join('order_product', 'order.order_id', '=', 'order_product.order_id')
// ->join('series_product', 'product.series', '=', 'series_product.id')
->get();

        $products=Product_order::where('order_id',$id)->get();
        // $banner = Banner::all();
        ...
        return view('super-admin/Dashboard/invoice',compact('history','products'));
    }
...
public function manageAdmin(){
    ...
    // $users= User::where("role", "!=", "Super Admin")->simplePaginate(5);

        return view('super-admin/Dashboard/manage-admin');
...
public function allUser(){
    ...
    // $users= User::where("role", "!=", "Super Admin")->simplePaginate(5);
        ...
        return view('super-admin/Dashboard/all-users');
...
public function notification()
{
    ...
    return view('super-admin/Dashboard/notification');
}
...
public function sendNotification(Request $request){
    ...
    if($request->for=="all"){
        ...
        $users = User::where('profession',$request->for)->get();
        foreach ($users as $user) {
        Notification::send($user, new MyNotification($title,$body));
          }
        return redirect()->back()->with('message','notification was successful!');
